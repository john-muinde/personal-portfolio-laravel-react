        ...
        HTTP.get(Routes.api.admin.about)
            .then((response) => {
                Utils.handleSuccessResponse(response, () => {
                    ...
                    setTagLines(
                        response.data.payload.taglines
                            ? JSON.parse(response.data.payload.taglines)
                            : []
                    );
                    setSocialLinks(
                        response.data.payload.social_links
                            ? JSON.parse(response.data.payload.social_links)
                            : []
                    );
                ...
                >
                    <PageWrapper loading={componentLoading}>
                        <List itemLayout="horizontal" size="large">
                            ...
                            <Item>
                                <Item.Meta
                                    title={<React.Fragment>CV</React.Fragment>}
                                    description={
                                        <FileUploader
                                            allowRevert={false}
                                            previewFile={
                                ...
                                <Item.Meta
                                    ...
                                    description={
                                        <FileUploader
                                            ...
                                            labelIdle={
                                                'Drag & Drop your cover or <span class="filepond--label-action">Browse</span>'
                                            }
                                            afterUploadCallback={
                                                coverUploadCallback
                                            }
                ...
                >
                    <PageWrapper loading={componentLoading}>
                        ...
                        >
                            ...
                            <Form.Item label={<Text strong>CV</Text>}>
                                {cv ? (
                                    <a
                                        href={Utils.backend + "/" + cv}
                                        download
                                        target="_blank"
                                        rel="noreferrer"
                                    >
            ...
            {socialLinkPopupVisible && (
                <SocialLinkPopup
                    ...
                    submitCallback={(newSocialLink) => {
                        ...
                        if (
                            typeof newSocialLink.index !== "undefined" &&
                            newSocialLink.index !== null
                        ) {
