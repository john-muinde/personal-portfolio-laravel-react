...
const Basic = (props) => {
    ...
    useEffect(() => {
        if (props.config) {
            ...
            setMaintenanceMode(
                parseInt(props.config.maintenanceMode) == 1 ? true : false
            );
        }
    }, [props.config]);
        ...
        <React.Fragment>
            {googleAnalyticsId ? (
                ...
                <React.Fragment>
                    ...
                    >
                        <Text type="secondary">
                            Click here to set google analytic id
                        </Text>
                    </Paragraph>
                </React.Fragment>
            )}
    ...
    const changeGoogleAnalyticsIdHandleSubmit = (e) => {
        ...
        submitData(
            CoreConstants.portfolioConfig.GOOGLE_ANALYTICS_ID,
            googleAnalyticsId
        );
    };
    ...
    const maintenanceModeOnChange = (checked) => {
        if (demoMode) {
            Utils.showNotification(
                "This feature is disabled in demo",
                "warning"
            );
        } else {
            const callback = () => {
            ...
            submitData(
                CoreConstants.portfolioConfig.MAINTENANCE_MODE,
                checked,
                callback
            );
        }
    ...
    const changeTemplate = (
        <Radio.Group
            onChange={(e) => templateOnClickHandler(e.target.value)}
            value={template}
        >
            <Row gutter={24}>
                    ...
                    return (
                        ...
                        >
                            <Card
                                ...
                                onClick={() =>
                                    templateOnClickHandler(element.id)
                                }
                                cover={
                                    <Image
                                        className="z-shadow"
                ...
                <List itemLayout="horizontal" size="large">
                    <Spin
                        ...
                        spinning={
                            ...
                            currentSettingToChange ===
                                CoreConstants.portfolioConfig.TEMPLATE
                        }
                    >
                        <StyledListItem style={{ padding: "16px 0px" }}>
                            <Item.Meta
                                title={"Portfolio Template"}
                                description={changeTemplate}
                            />
                        </StyledListItem>
                    </Spin>
                    <Spin
                        ...
                        spinning={
                            loading &&
                            currentSettingToChange ===
                                CoreConstants.portfolioConfig.ACCENT_COLOR
                        }
                    >
                        <StyledListItem
                            actions={[
                        ...
                        >
                            <Item.Meta
                                ...
                                description={"Change accent color of frontend."}
                            />
                        </StyledListItem>
                    </Spin>
                    <Spin
                    ...
                    >
                        <StyledListItem
                            actions={[
                                <a
                                    ...
                                    onClick={
                                        changeGoogleAnalyticsIdHandleSubmit
                                    }
                                >
                                    Change
                                </a>,
                        ...
                        >
                            <Item.Meta
                                ...
                                description={changeGoogleAnalyticsId}
                            />
                        </StyledListItem>
                    </Spin>
                    <StyledListItem
                    ...
                    >
                        <Item.Meta
                            title={"SEO"}
                            description={
                                "Search engine optimization of frontend."
                            }
                        />
                    </StyledListItem>
                    <Spin
                    ...
                    >
                        ...
                        >
                            <Item.Meta
                                ...
                                description={
                                    "Set maintenance mode of frontend."
                                }
                            />
                        </StyledListItem>
                    </Spin>
